...
class _ExibirPedidosState extends State<ExibirPedidos> {
  ...
  void _asyncMethod() async {
    ...
    await control.pegarProdutosDoPedido(this.pedido).then((onValue) {
      setState(() {
  ...
  Future<List> alterarProdutos(Pedido p) async {
    return await control.pegarProdutosDoPedido(p);
  }
  ...
  Widget setupAlertDialoadContainer(Pedido p) {
    return FutureBuilder(
        future: alterarProdutos(p),
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            p.setProdutos(snapshot.data);
            return Container(
