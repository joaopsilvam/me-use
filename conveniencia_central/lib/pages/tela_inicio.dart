...
class _TelaInicioState extends State<TelaInicio> {
              ...
              Container(
                child: Column(
                  children: <Widget>[
                    Container(
                      width: MediaQuery.of(context).size.width*0.8,
                      child: Text("E-mail", style: TextStyle(fontSize: 14, fontFamily: "Century Gothic", fontWeight: FontWeight.bold,),),
                    ),
                    Container(
                      height: 50,
  ...
  void logarUsuario() async{
    ...
    var usuario = await controle.pegarUsuarioPorCredenciais(this.email, this.senha);
