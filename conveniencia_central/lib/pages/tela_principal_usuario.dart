            ...
            Row(
              ...
              children: <Widget>[
                Container(
                    ...
                    child: SingleChildScrollView(
                      child: Text(
                        "Olá, ${this.controle.usuario.nome.split(" ")[0]} ${this.controle.usuario.nome.split(" ")[1]}.",
                        style: TextStyle(
                            ...
                            child: Column(
                              children: <Widget>[
                                ...
                                Container(
                                  ...
                                  height: 25,
                                  child: Text(
                                      '\$${formatador.format(num.parse(this.produtos2[index].preco.toStringAsPrecision(10)))}',
                                      style: TextStyle(
                                          fontSize: MediaQuery.of(context)
                                                  .size
                                                  .width *
            ...
            return FlatButton(
              onPressed: () {
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            ProdutosPorCategoria(this.categorias[index])));
              },
              child: Column(
                children: <Widget>[
                  ClipRRect(
                  ...
                  Container(
                    ...
                    alignment: Alignment.centerLeft,
                    width: MediaQuery.of(context).size.width * 0.65,
                    child: Text('${this.categorias[index].nome}',
                        style: TextStyle(
                  ...
                  Container(
                    ...
                    alignment: Alignment.centerLeft,
                    width: MediaQuery.of(context).size.width * 0.65,
                    child: Text('${this.categorias[index].subtitulo}',
                        style: TextStyle(
                      ...
                      Column(
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            width: MediaQuery.of(context).size.width * 0.5,
                            child: Text(
                                'R\$ ${formatador.format(num.parse(this.produtos[index].preco.toStringAsPrecision(10)))}',
                                style: TextStyle(
                                    fontSize:
                                        MediaQuery.of(context).size.width *
                                            0.035,
